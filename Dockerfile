...
# Do not use the intel-opencl-icd package from repo since they will not build with RELEASE_WITH_REGKEYS enabled.
 ...
 && wget http://http.us.debian.org/debian/pool/non-free/i/intel-media-driver-non-free/intel-media-va-driver-non-free_21.1.1+ds1-1_i386.deb \
 && dpkg -i *.deb \
 && cd .. \
 ...
 && sed -i -e 's/# en_US.UTF-8 UTF-8/zh_CN.UTF-8 UTF-8/' /etc/locale.gen && locale-gen
